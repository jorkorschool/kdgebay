...
async def watch(ctx, *args):
    ...
    if 'www.ebay.com' in itemlink:
        try:
            ...
            embed.set_footer(text='KDG - @k0rnsyrup', icon_url='https://pbs.twimg.com/profile_images/907483749306204160/xhFgvLdV_400x400.jpg')
            await bot.send_message(ctx.message.channel, embed=embed)
            return
    ...
    embed = discord.Embed(title="Sent {} Watchers!".format(number_of_watchers), color=0x2ecc71)
    embed.set_footer(text='KDG - @k0rnsyrup', icon_url='https://pbs.twimg.com/profile_images/907483749306204160/xhFgvLdV_400x400.jpg')
    await bot.send_message(ctx.message.channel, embed=embed)
...
if __name__ == '__main__':
    bot.run('NTA5MTE2MDgxOTA2OTA5MTg0.DveDRA.WgzUjWZozPEdCSfwF2uCp6IwdhI')
